...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: SubmitEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      alert(`Backend response: ${data.message || 'Signup successful'}`);
    } catch (error: any) {
      ...
      <div className="bg-white shadow-2xl flex flex-col items-center relative w-full max-w-[400px]"
        ...
        <div className="mb-4 mt-2 sm:mt-4 text-center">
          <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[55px] h-[55px] sm:w-[70px] sm:h-[70px] inline-block">
            <path d="M5 10 L95 10 L50 95 Z" fill="url(#blueGradSignupZ)" />
            {/* Bold Centered Z */}
            <path d="M30 35 H70 L30 65 H70" stroke="white" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
            <defs>
              <linearGradient id="blueGradSignupZ" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        {/* Headings */}
        <h1 className="text-gray-700 font-semibold mb-1 text-[20px] sm:text-[22px]">Welcome!</h1>
        <p className="text-gray-400 mb-4 sm:mb-6 text-[12px] sm:text-[13px] text-center">Create your account</p>
        ...
        {/* Divider */}
        <div className="w-full flex items-center justify-center mt-6 sm:mt-10 mb-4 sm:mb-6">
          <div className="h-px bg-gray-200 flex-grow"></div>
          <span className="text-gray-400 font-medium px-4 text-[10px] sm:text-[11px] tracking-tight uppercase whitespace-nowrap">Or sign up with</span>
          <div className="h-px bg-gray-200 flex-grow"></div>
        </div>
